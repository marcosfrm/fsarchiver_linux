Shell script que uso no SystemRescueCD para restaurar imagem do FSArchiver, contendo uma única partição (nada de swap) e apagando todos os dados do disco de destino.
